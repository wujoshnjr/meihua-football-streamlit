...
這是一個負責「文字取數、完整排卦與卦義資料」的 Streamlit 系統。除本卦、互卦、動爻與變卦外，也固定提供日辰、月令、旬空、三卦納甲、八宮世應、雙軌六親、六沖六合、經傳與足球應用參考。
...
應用啟動時會驗證 8 卦、64 卦、384 爻、960 個卦義／足球欄位與《焦氏易林》4,096 條林辭是否齊全；缺欄位會直接報錯，不會靜默顯示不完整資料。
